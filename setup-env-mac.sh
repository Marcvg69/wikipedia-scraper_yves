...
python3.12 -m venv .venv || print_error "Python 3.12 not found. Please install it (e.g. via pyenv or Homebrew)."

# === Activate venv ===
echo ">>> Activating virtual environment..."
source .venv/bin/activate || print_error "Failed to activate venv."
...
print_blue "Registering virtual environment in Jupyter kernels..."
